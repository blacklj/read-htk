...
/* NewItemBlock: create and return an emptry ItemBlock 创建block，每个block存储了blkSize个指向item的指针 */
...
/* 这里fvSegs是Sequence类型，其中每一个block中存储的item也是一个Sequence类型，对应一个segment */
...
static ClusterSet *ccs; /* current cluster set 当前聚类集合 */
...
/* FindCentres: of clusters a..b 找a~b之间每一个cluster的质心 */
